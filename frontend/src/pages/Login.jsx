...
function Login() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-pink-600 via-purple-600 to-indigo-700 flex items-center justify-center px-4 py-10">
      ...
      <div className="absolute -top-24 -left-24 w-72 h-72 bg-pink-400/30 rounded-full blur-2xl"></div>

      <div className="absolute -bottom-24 -right-24 w-80 h-80 bg-blue-400/30 rounded-full blur-2xl"></div>
        ...
        <div className="bg-white/95 backdrop-blur-sm border border-white/30 rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-7 bg-gradient-to-r from-pink-600 to-purple-600 text-white py-3.5 rounded-xl font-semibold shadow-md hover:shadow-lg hover:from-pink-700 hover:to-purple-700 transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
